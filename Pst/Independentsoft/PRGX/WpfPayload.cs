...
namespace System.Windows.Documents
{
  ...
  internal class WpfPayload
  {
    ...
    /// </returns>
    internal static string SaveRange(TextRange range, ref Stream stream, bool useFlowDocumentAsRoot)
    {
    ...
    /// A xaml part of serialized content.
    /// </returns>
    internal static string SaveRange(TextRange range, ref Stream stream, bool useFlowDocumentAsRoot, bool preserveTextElements)
    {
      if (range == null)
      {
      ...
      //todo prgx: TextRangeSerialization.WriteXaml(xmlWriter, range, useFlowDocumentAsRoot, wpfPayload, preserveTextElements);
    ...
    private BitmapSource GetBitmapSourceFromImage(Image image)
    {
      ...
      //todo prgx      DpiScale dpi = image.GetDpi();
      DrawingImage di = (DrawingImage)image.Source;
//todo prgx      RenderTargetBitmap rtb = new RenderTargetBitmap((int)(di.Width * dpi.DpiScaleX), (int)(di.Height * dpi.DpiScaleY),
      RenderTargetBitmap rtb = new RenderTargetBitmap((int)(di.Width), (int)(di.Height),
