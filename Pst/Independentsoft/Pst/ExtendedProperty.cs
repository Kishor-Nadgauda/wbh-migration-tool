...
namespace Independentsoft.Pst
{
    ...
    public class ExtendedProperty
    {
        ...
        internal ExtendedProperty(System.Text.Encoding pstFileEncoding)
        {
        ...
        public string GetStringValue()
        {
            if (value != null)
            {
                ...
                {
                    return pstFileEncoding.GetString(value, 0, value.Length);
                }
                else
                {
                    return null;
        ...
        public string[] GetStringArrayValue()
        {
            if (value != null)
            {
                if (tag.Type == PropertyType.StringArray)
                {
                    return Util.GetStringArrayValue(value, System.Text.Encoding.Unicode);
                }
                else if (tag.Type == PropertyType.String8Array)
                {
                    return Util.GetStringArrayValue(value, pstFileEncoding);
                }
                else
                {
                    return new string[0];
        ...
        public short GetShortValue()
        {
            if (value != null)
            {
                if (tag.Type == PropertyType.Short && value.Length == 2)
                {
        ...
        public int GetIntegerValue()
        {
            if (value != null)
            {
                if (tag.Type == PropertyType.Integer && value.Length == 4)
                {
        ...
        public long GetLongValue()
        {
            if (value != null)
            {
                if (tag.Type == PropertyType.Long && value.Length == 8)
                {
        ...
        public float GetFloatValue()
        {
            if (value != null)
            {
                if (tag.Type == PropertyType.Float && value.Length == 4)
                {
        ...
        public double GetDoubleValue()
        {
            if (value != null)
            {
                if (tag.Type == PropertyType.Double && value.Length == 8)
                {
        ...
        public DateTime GetDateTimeValue()
        {
            if (value != null)
            {
                if ((tag.Type == PropertyType.ApplicationTime || tag.Type == PropertyType.SystemTime) && value.Length == 8)
                {
